...
<font color="green">Latest update: 8/1/2025</font>
...
I was honored to have been mentored by two great scholars in the areas of presence and virtual/augmented reality: [Dr. Matthew Lombard](https://klein.temple.edu/faculty/matthew-lombard) and [Dr. Tony Liao](https://www.ist.uh.edu/faculty/liao-tony). 
...
[4] Applying diverse methods to understand broad emerging media effects, including those in VR, AR, and mobile media.
...
![](images/masa2.png){.center .img-medium}
...
![](images/robot.png){.center .img-medium}
![](images/multidimensional.png){.center .img-medium}
...
![](images/JCMC.png){.center .img-medium}
...
![](images/garbagerecycle.png){.float-left .img-small} 

![](images/robot transparency.png){.float-left .img-small}
...
![](images/XAI.png){.center .img-medium}
...
<font color="green">**[4] Applying diverse methods to understand broad emerging media effects:**</font>



My last line of research adopts various methods and analyses to understand emerging technologies, including VR, AR, and mobile media. Those methods include computational methods (e.g., unsupervised learning, geographic information systems), structural equation modeling, meta-analysis, multidimensional scaling, semiotic analysis, and interviews. 

![](images/AR map.png){.float-left .img-medium}
